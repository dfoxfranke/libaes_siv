...
static void test_vector_1() {
        ...
        const unsigned char ad[] = {0x10, 0x11, 0x12, 0x13, 0x14, 0x15,
                                    0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b,
                                    0x1c, 0x1d, 0x1e, 0x1f, 0x20, 0x21,
                                    0x22, 0x23, 0x24, 0x25, 0x26, 0x27};

        const unsigned char plaintext[] = {0x11, 0x22, 0x33, 0x44, 0x55,
...
static void test_vector_2() {
        ...
        const unsigned char ad2[] = {0x10, 0x20, 0x30, 0x40, 0x50,
                                     0x60, 0x70, 0x80, 0x90, 0xa0};

        const unsigned char nonce[] = {0x09, 0xf9, 0x11, 0x02, 0x9d, 0x74,
                                       0xe3, 0x5b, 0xd8, 0x41, 0x56, 0xc5,
                                       0x63, 0x56, 0x88, 0xc0};

        const unsigned char plaintext[] = {
            0x74, 0x68, 0x69, 0x73, 0x20, 0x69, 0x73, 0x20, 0x73, 0x6f,
        ...
        const unsigned char ciphertext[] = {
            0x7b, 0xdb, 0x6e, 0x3b, 0x43, 0x26, 0x67, 0xeb, 0x06, 0xf4, 0xd1,
            0x4b, 0xff, 0x2f, 0xbd, 0x0f, 0xcb, 0x90, 0x0f, 0x2f, 0xdd, 0xbe,
            0x40, 0x43, 0x26, 0x60, 0x19, 0x65, 0xc8, 0x89, 0xbf, 0x17, 0xdb,
            0xa7, 0x7c, 0xeb, 0x09, 0x4f, 0xa6, 0x63, 0xb7, 0xa3, 0xf7, 0x48,
            0xba, 0x8a, 0xf8, 0x29, 0xea, 0x64, 0xad, 0x54, 0x4a, 0x27, 0x2e,
            0x9c, 0x48, 0x5b, 0x62, 0xa3, 0xfd, 0x5c, 0x0d};
...
static void test_384bit() {
        const unsigned char key[] = {
            ...
            0xfe, 0xff, 0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8,
        ...
        const unsigned char ciphertext[] = {
            ...
            0x96, 0x39, 0x62, 0xfe, 0x07, 0x40, 0xef, 0xf3, 0x56, 0xe4,
            0x2d, 0xec, 0x1f, 0x4f, 0xeb, 0xde, 0xd3, 0x66, 0x42, 0xf2};
...
static void test_512bit() {
        const unsigned char key[] = {
            0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8, 0xf7, 0xf6, 0xf5,
            0xf4, 0xf3, 0xf2, 0xf1, 0xf0, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5,
            0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe, 0xff, 0xf0,
            0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb,
            0xfc, 0xfd, 0xfe, 0xff, 0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9,
        ...
        const unsigned char ciphertext[] = {
            0x72, 0x4d, 0xfb, 0x2e, 0xaf, 0x94, 0xdb, 0xb1, 0x9b, 0x0b,
            0xa3, 0xa2, 0x99, 0xa0, 0x80, 0x1e, 0xf3, 0xb0, 0x5a, 0x55,
            0x49, 0x8e, 0xc2, 0x55, 0x26, 0x90, 0xb8, 0x98, 0x10, 0xe4};
...
static void test_copy() {
        ...
        const unsigned char plaintext1[] = {0x11, 0x22, 0x33, 0x44, 0x55,
                                            0x66, 0x77, 0x88, 0x99, 0xaa,
                                            0xbb, 0xcc, 0xdd, 0xee};

        const unsigned char plaintext2[] = {0x11, 0x22, 0x33, 0x44, 0x55,
                                            0x66, 0x77, 0x88, 0x99, 0xaa,
                                            0xbb, 0xcc, 0xdd, 0xef};
